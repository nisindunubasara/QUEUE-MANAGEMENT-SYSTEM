...
const ALLOWED_TENANTS = new Set(["bank", "supermarket"]);
...
export default function CompanySuperAdminBranchRequests() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-500">
          Review and process pending bank and supermarket branch requests.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 text-sm text-slate-600 shadow-sm">
          No pending branch requests found for bank or supermarket tenants.
        </div>
      ) : (
