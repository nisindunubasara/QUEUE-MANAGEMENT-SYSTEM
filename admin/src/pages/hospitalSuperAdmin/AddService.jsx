...
export default function HospitalSuperAdminAddService() {
  ...
  const handleSave = (event) => {
    ...
    // Local state only for now; backend integration comes later.
    console.log("Service draft:", form);
    navigate("/hospital-super-admin/services");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mt-2 text-gray-600">Create a new hospital service profile</p>
        ...
        <form onSubmit={handleSave} className="mt-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-end">
            <button
              type="button"
              onClick={() => navigate("/hospital-super-admin/services")}
