...
export default function BankSuperAdminAddBank() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // මෙහි tenantType එක 'bank' ලෙස ස්ථිරවම ලබා දී ඇත.
      const selectedTenantType = "bank";
      ...
      const message =
        ...
        "Bank organization, main branch, and organization admin created successfully";

      setSuccessMessage(message);
      
      // සාර්ථක වූ පසු Organizations ලැයිස්තුවට යවයි
      navigate("/bank-super-admin/organizations", {
        state: {
          successMessage: message,
        },
      });
    } catch (submitError) {
      setError(submitError?.message || "Failed to save bank and create admin");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 py-12">
      <div className="mx-auto max-w-5xl">
        <h1 className="text-3xl font-bold text-gray-900">Add Bank Organization</h1>
        <p className="mt-2 text-gray-600">Register a bank and create organization admin access</p>
